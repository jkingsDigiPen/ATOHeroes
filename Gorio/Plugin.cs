...
namespace Gorio
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, "Gorio", PluginInfo.PLUGIN_VERSION)]
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Gorio";
        public static string heroName = characterName;

        public static string subclassName = "Shaman"; // needs caps
